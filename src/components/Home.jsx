    ...
    <>
      <Box sx={{ py: 12, position: "relative", background: "#fff", mt: 5 }}>
        <Container maxWidth="lg" sx={{ position: "relative" }}>
          ...
          {/* Main Content */}
          <Grow in={true} timeout={1000}>
            <Box textAlign="center" zIndex={1} position="relative">
              <Typography
                variant="h3"
                sx={{
                  fontWeight: "bold",
...
<Button
  ...
  sx={{
    ...
    textTransform: "none",
    borderRadius: "999px",
    animation: "glow 3s ease-in-out infinite, shake 0.5s ease-in-out infinite",
...
>
  ...
  <Container maxWidth="lg" sx={{ position: "relative", zIndex: 2 }}>
    ...
    >
      {[
        {
          icon: <BookmarksOutlined sx={{ fontSize: 48, color: "#3f51b5" }} />,
          title: "Continuous enhancement",
          description:
            "We continuously enhance our assessment methodologies and technologies to ensure precise evaluation and reliable results.",
        },
        ...
        {
          icon: <FavoriteBorder sx={{ fontSize: 48, color: "#00c853" }} />,
          title: "Contribution",
          description:
            "We contribute to the national agenda of skill development by supporting the goals and initiatives of the MSDE.",
        },
